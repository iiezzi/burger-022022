...
<head>
    ...
    <title>Recuperar contraseña Burguer SRL</title>
...
<body id="signup">
    ...
    <main id="recover-main">
        <div class="signup-container">
            <h1 class="tittle-signup">Contraseña</h1>
            <form action="" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}"></input>
                <div class="password-recover">
                    <label for="Correo">Ingresa tu email:</label>
                </div>
                <input type="email" id="txtCorreo" name="txtCorreo" placeholder="Correo electrónico">
            </form>
